...
Source: https://www.tradingview.com/pine-script-docs/writing/
...
Script
Publishing](https://www.tradingview.com/support/solutions/43000590599)which preempt the author’s license.
...
* Their declaration uses the optional `const` keyword (see our User
  Manual’s section on[type qualifiers](/pine-script-docs/language/type-system/#qualifiers) for more information).
...
candle-plotting, etc. See the Pine Script user manual’s section on[Z-index](/pine-script-docs/visuals/overview/#z-index) for more
